...
class SnapshotTest {
	...
	void sparseViewHasNoBenchmarkButKeepsLowestCaseAndNullGap() {
		List<DealRef> cases = List.of(
				new DealRef(870_000L, LocalDate.of(2026, 3, 1), "ppomppu", "https://p.test/1", List.of(), 1L),
				new DealRef(820_000L, LocalDate.of(2026, 3, 2), "ruliweb", "https://r.test/2", List.of(), 2L));
