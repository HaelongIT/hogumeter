...
/**
 * 현재가 스텁 — 네이버 쇼핑 API 키 미발급이라 현재가 <b>미확립(null)</b>을 반환한다(Q-3·Q-20·Q-53).
 * 기준가 산식(tier·median·P25·n·m)은 현재가와 무관하므로 정상 동작하며, 갭만 미확립(null).
 * 0을 반환하면 갭이 −100%로 계산돼 "지금 100% 싸다"는 거짓 신호가 된다 — 그래서 null이다.
