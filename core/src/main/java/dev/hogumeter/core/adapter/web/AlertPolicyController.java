 ...
 *
 * <p>다루는 필드는 {@code AlertPolicyEntity}가 매핑한 넷뿐이다. {@code k_display}·{@code exclude_keywords}·
 * ⚠️라벨 토글은 엔티티 매핑 확장이 선행한다(docs/91 Q-48).
 */
@RestController
public class AlertPolicyController {
	...
	public record AlertPolicyView(boolean configured, Long targetPrice, Integer periodMonths,
			Integer quietHoursStart, Integer quietHoursEnd, Integer kDisplay) {
